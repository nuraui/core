...
The minimal `package.json` shall look like this.
...
It's a good time to open your project folder in a code editor like Visual Studio Code, if you still haven't done it.
